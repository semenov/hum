...
events = [
    (0.3, PROMPT),
    (0.9, "brew tap semenov/hum https://github.com/semenov/hum"),
    (1.5, "\r\n"),
    (1.9, "==> Tapping semenov/hum\r\nTapped 1 formula (48 files, 1.8MB).\r\n"),
    (2.2, PROMPT),
    (2.7, "brew trust semenov/hum"),
    (3.1, "\r\n"),
    (3.4, "Trusted tap: https://github.com/semenov/hum\r\n"),
    (3.7, PROMPT),
    (4.2, "brew install --HEAD hum"),
    (4.7, "\r\n"),
    (5.0, "==> Installing hum from semenov/hum\r\n"),
    (5.4, f"==> {DIM}python3.12 -m venv .../libexec/venv{RST}\r\n"),
    (5.9, f"==> {DIM}pip install --quiet mlx-lm llguidance{RST}\r\n"),
    (6.6, f"==> {DIM}go build -ldflags ...{RST}\r\n"),
    (7.2, "🍺  /opt/homebrew/Cellar/hum/HEAD: 432.5MB, built in 17 seconds\r\n"),
    (7.7, PROMPT),
    (8.3, "hum start"),
    (8.8, "\r\n"),
